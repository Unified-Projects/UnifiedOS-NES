...
PPU2C02::PPU2C02()
    : sprScreen{vec2{256, 240}, new uint8_t[256 * 240 * 4]}, sprNameTable{PixelImage{vec2{256, 256}, new uint8_t[128 * 128 * 4]}, PixelImage{vec2{256, 256}, new uint8_t[256 * 256 * 4]}}, sprPatternTable{PixelImage{vec2{128, 128}, new uint8_t[128 * 128 * 4]}, PixelImage{vec2{128, 128}, new uint8_t[256 * 240 * 4]}}
{
...
void PPU2C02::clock(){
    ...
    //TextureGen
    sprScreen.SetPixel(vec2{cycle-1, scanline}, GetColorFromPaletteRam(palette, pixel));
